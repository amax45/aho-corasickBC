...
//    static int buildMatchingMachine(ArrayList<ArrayList<String>> titles, int k) {
//
...
//        for (int i = 0; i < k; ++i) {
//            //int j=0;
//            //String arra[] = titles.get(i).split(",");
//
//            for (int j = 0; j < 3; ++j) {
//                String word = arra[j];
...
//    static void searchWords(ArrayList<String> titles, int k,
//                            String text) {
//
//        // Preprocess patterns.
//        // Build machine with goto, failure
//        // and output functions
//        buildMatchingMachine(titles, k);
//
...
//            for (int j = 0; j < k; ++j) {
//                String arra[] = titles.get(j).split(",");
//
//                if ((out[currentState] & (1 << j)) > 0) {
//                    System.out.print("Word " + titles.get(j) +
//
//                            /*
//                    for (int i = 0; i < k; ++i) {
//                        //int j=0;
